...
import { buscarEmojisDaGuilda } from "../discord/rest.ts";
...
export async function handleDiagnostico(interaction: DiscordInteraction): Promise<HandlerResult> {
  ...
  return { immediate: reply(relatorio, { ephemeral: true }) };
}
